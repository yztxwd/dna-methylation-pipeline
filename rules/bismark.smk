rule bismark_mapping_pe:
    ...
    shell:
        ...
        bismark {params.extra} -o output/mapped/ -B {params.basename} --multicore 4 {params.index} -1 {input[0]} -2 {input[1]} > {log}
        """
...
rule bismark_mapping_se:
    ...
    shell:
        """
        # multicore is hardcoded as 4
        bismark {params.extra} -o output/mapped/ -B {params.basename} --multicore 4 {params.index} {input} > {log}
        """
